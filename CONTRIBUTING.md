...
Build only within your pair folder. Use one driver to submit the work. Test valid and invalid activity entries, mobile width, keyboard controls and feedback. Update your README with the motivation hypothesis, changes, limitations and next step. Inspect the diff, commit, push your branch and open a PR against artur-octalysis/tog-learning main. The facilitator reviews and merges; Pages publishes after successful validation. Never force-push main.
